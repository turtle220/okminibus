    ...
    <div class="modal-content">
	      ...
	      <div class="modal-body" style="height:450px;overflow:auto;">
	        ...
	        <div class="fieldsRow">
	      	...
	      	<div class="fieldsRow">
	      		<div class="fieldsLabel">{{__('custom.transfer')}}:</div><div class="fieldsValue"><!--Traslado -->
					<input id="transfer" name="transfer" type="text" class="form-control" placeholder="ITraslado" value="{{ $BookingTicket->transfer }}" />
	      		</div>
	      ...
	      <div class="modal-footer">
	        ...
	        @if ($BookingTicket->BTicketRef != "")
	        	<button type="button" class="btn btn-default" onClick="ShowBookingTicket('{{ $BookingTicket->BTicketId }}')">{{__('custom.cancel') }}</button><!--Cancelar-->
	        @endif
