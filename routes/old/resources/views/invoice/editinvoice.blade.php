...
<div style="margin-right: -15px;">
    ...
    <form action="{{ url('viewinvoice') }}" method="post" style="display: inline-block;">
        ...
        <button type="submit" class="btn btn-primary"><i class="fa fa-"></i> &nbsp;{{__('custom.back') }}</button>
    </form>
	...
	<div class="container excel-wrap widt">
		...
		<div class="row border-bottom padding-bottom">
			<div class="col-md-12">	
				...
				<div class="col-md-10">
					<input type="form-control" class="form-control" name="Hotel" value="{{$value[0]->Hotel}}">
				</div>
			</div>
		</div>
		...
		<div class="row">
			<div class="col-md-12">		
				<div class="col-md-4">
					<textarea name="price" rows="10" class="width-100">
		...
		<div class="row">
			<div class="col-md-12">		
				<div class="col-md-12">
					<textarea rows="10" name="observation" class="width-100">
		...
		<div class="row">
			...
			<div class="col-md-8">
				<input type="form-control" class="form-control" name="DFlightNo" value="{{$value[0]->DFlightNo}}">
			</div>
			</div>
		</div>
