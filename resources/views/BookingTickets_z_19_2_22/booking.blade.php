							    ...
							    <tr>
                                  ...
                                  <td>
                                    <form method="POST" action="{{ url('viewinvoice') }}">
                                        ...
                                        <button type="submit" class="myButton" value="{{__('custom.viewinvoice') }}"><i class="fa fa-tag"></i>&nbsp{{__('custom.viewinvoice')}}</button>
                                    </form> 
                ...
                $(document).on('click', 'li', function(){
                    ...
                    $.ajax({
                        ...
                        success:function(data){
                            ...
                            var optionValue  = data['BookingTickets']['StatusId'];
                            ...
                            for(var i = 0; i < length; i++)
                            {
                               ...
                               // if(data['BookingTickets']['destination'] == data['areas'][i]['name'])
                               //  $("#sdestination").append(new Option(data['areas'][i]['name'], data['areas'][i]['name'],true));
                              
                               // else
                               //  $("#sdestination").append(new Option(data['areas'][i]['name'], data['areas'][i]['name']));   
                            }
