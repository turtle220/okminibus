...
<div style="box-sizing: border-box;-moz-box-sizing:    border-box;-webkit-box-sizing: border-box;">
	...
	<div style="position:absolute;top:445px;left:10px;width:140px;height:50px;font-size:20px;font-weight:bold;border:1px solid #000;text-align:center;line-height:43px;color:#fff;background:#999">
	...
	<div style="position:absolute;top:695px;left:350px;width:120px;height:50px;font-size:17px;font-weight:bold;border:1px solid #000;text-align:center;line-height:43px;color:#fff;background:#999">
	...
	<div style="position:absolute;top:745px;left:350px;width:100px;height:50px;font-size:24px;font-weight:bold;border:1px solid #000;text-align:center;line-height:43px;color:#fff;background:#999">
	...
	<div style="position:absolute;top:795px;left:10px;width:140px;height:50px;font-size:18px;font-weight:bold;border:1px solid #000;text-align:center;line-height:23px;color:#fff;background:#999">

			extras (bike, glof,etc...)

	</div>

	<div style="position:absolute;top:795px;left:150px;width:530px;height:50px;font-size:24px;font-weight:bold;border:1px solid #000;text-align:left;line-height:43px;color:#000;background:#ccc;padding-left:10px">
